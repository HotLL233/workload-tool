...
export const updateRdRecord = (id: number, data: { user_name?: string; quantity?: number; recorded_at?: string; project_id?: number; method_id?: number | null; batch_no?: string; notes?: string }): Promise<ApiResponse<WorkRecord>> =>
