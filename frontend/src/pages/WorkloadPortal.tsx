  ...
  return (<PageEditProvider>
    <Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        <PageSectionEditor pageKey="workload_portal" sectionKey="page-title" defaultLabel="分析检测">
      ...
      <PageSectionEditor pageKey="workload_portal" sectionKey="division-chips">
      ...
      <PageSectionEditor pageKey="workload_portal" sectionKey="group-cards">
